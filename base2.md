...
Хороший пример недетерминированной функции - вывод возраста пользователя. При одинаковых входных параметрах, но вызовах в разное время, она будет возвращать разный результат.
